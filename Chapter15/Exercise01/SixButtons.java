...
public class SixButtons extends JFrame{
	public SixButtons(){
		...
		jbt01.addActionListener(listener);
		jbt02.addActionListener(listener);
		jbt03.addActionListener(listener);
		jbt04.addActionListener(listener);
		jbt05.addActionListener(listener);
		jbt06.addActionListener(listener);
	}
